...
import { mapVportServiceCatalogRows } from "@/features/vport/models/vportServiceCatalog.model";
import { resolveVportServiceCatalogType } from "@/features/profiles/kinds/vport/adapters/config/vportTypes.config.adapter";

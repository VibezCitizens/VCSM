...
import { useResetPassword } from '@/features/auth/password-recovery/hooks/useResetPassword'
            ...
            <>
              ...
              <form className="mt-4 space-y-4" onSubmit={handleReset} noValidate>
                ...
                {cooldownSeconds > 0 && !loading ? (
                  <p className="text-center text-xs text-[#9ca3af]">
                    {t('auth.forgot.cooldownMessage', { seconds: cooldownSeconds })}
                  </p>
                ) : null}
              </form>

// src/features/post/commentcard/components/CommentComposeModal.jsx
// ============================================================
// CommentComposeModal (UI ONLY)
// - Fullscreen overlay
...
const CommentComposeModal = forwardRef(function CommentComposeModal(
  ...
  // 👇 expose focus() so parent can focus during the tap gesture
    ...
    <div className="fixed inset-0 z-[9999]" aria-modal="true" role="dialog">
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <div className="text-sm text-white/85 font-medium">New Spark</div>

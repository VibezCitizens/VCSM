...
import { useCommentVisibility } from "@/features/moderation/adapters/hooks/useCommentVisibility.adapter";
...
export default function useCommentCovers({
  ...
  const { expandHiddenRootsToDescendants, getHiddenCommentIdsForActor } =
  ...
  }, [actorId, allIds, getHiddenCommentIdsForActor]);
  ...
  }, [propagateRootToReplies, commentTree, base, expandHiddenRootsToDescendants]);

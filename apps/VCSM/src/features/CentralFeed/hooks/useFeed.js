// src/features/CentralFeed/hooks/useFeed.js
...
import { withTimeout, preloadInitialMedia } from "@/features/CentralFeed/hooks/useFeed.utils";
...
export function useFeed(viewerActorId, realmId, { viewerIsAdult: viewerIsAdultProp = null } = {}) {
  ...
  // viewerIsAdult is passed from the caller via useActiveActorState().isAdult.

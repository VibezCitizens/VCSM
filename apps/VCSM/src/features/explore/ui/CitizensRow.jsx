    ...
    <section className="explore-discovery-card px-1">
      ...
      <div className="flex gap-3 overflow-x-auto">
        {[1, 2, 3, 4, 5].map((i) => (
          <div
            key={i}
            className="min-w-[120px] rounded-xl p-3 flex flex-col items-center border border-purple-300/15 bg-black/45"
          >
            <div className="w-14 h-14 rounded-lg bg-gradient-to-br from-indigo-500 to-sky-500 mb-2" />

            <span className="text-xs truncate w-full text-center text-white">
              Citizen_{i}
            </span>
          </div>
        ))}

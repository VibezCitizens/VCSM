...
import { dedupeByKindAndId, normalizeResult } from '@/features/explore/models/search.model'
import { hydrateActorsByIds } from '@hydration'

export async function ctrlSearchResults({ query, filter, viewerActorId = null }) {

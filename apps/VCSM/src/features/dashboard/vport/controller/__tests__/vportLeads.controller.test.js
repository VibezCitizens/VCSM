...
vi.mock('@/features/dashboard/vport/dal/read/vportLeads.read.dal', () => ({
  readVportBusinessCardLeadsByProfileDAL: vi.fn(),
  readNewLeadsCountByProfileDAL:          vi.fn(),
}))
vi.mock('@/features/dashboard/vport/dal/write/vportLeads.write.dal', () => ({
  deleteVportBusinessCardLeadDAL:         vi.fn(),
  markVportBusinessCardLeadContactedDAL:  vi.fn(),
}))
vi.mock('@/features/dashboard/vport/model/vportLead.model', () => ({

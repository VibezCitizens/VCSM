...
import { useSaveVportPublicDetailsByActorId } from "@/features/dashboard/vport/dashboard/cards/settings/hooks/useSaveVportPublicDetailsByActorId";
import { mapPublicDetailsToDraft } from "@/features/dashboard/vport/dashboard/cards/settings/model/vportSettingsDraft.model";
import {
  normalizeAddress,
  hasAnyAddressValue,
  hasCompleteAddress,

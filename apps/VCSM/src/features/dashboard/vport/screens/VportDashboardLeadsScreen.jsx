...
import {
  ...
  formatSourceLabel,
  previewMessage,
} from "@/features/dashboard/vport/screens/vportDashboardLeadsScreen.model";

export default function VportDashboardLeadsScreen() {
  ...
  const {
    ...
    markContacted,
    deleteLead,
  } = useVportLeads(isOwner ? actorId : null);

...
import { useVportTeamAccess } from "@/features/vportDashboard/dashboard/cards/team/hooks/useVportTeamAccess";
import { TeamMemberCard } from "./components/team/TeamMemberCards";
import { AddTeamMemberSheet } from "./components/team/AddTeamMemberSheet";
import { ConfirmRemoveModal } from "./components/team/ConfirmRemoveModal";
...
export function VportDashboardTeamScreen() {
  ...
  const { loading: ownershipLoading, callerActorId: viewerActorId, vportActorId: actorId, canManage: isOwner } = useVportDashboardContext();

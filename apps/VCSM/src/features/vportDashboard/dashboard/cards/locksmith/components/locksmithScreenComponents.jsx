...
import { buildLocksmithArea } from "../model/locksmithArea.model";
...
export function AreaForm({ initial, onSave, onCancel, saving }) {
  ...
  const handleSubmit = () => {
    const area = buildLocksmithArea({ label, city, stateCode, zipCode, radiusMiles, minEta, maxEta, travelFee, emergency });

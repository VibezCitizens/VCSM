...
import { BulkUpdateFuelPricesModal } from "@/features/vportDashboard/dashboard/cards/gasprices/components/BulkUpdateFuelPricesModal";
import {
  resolveFuelKeys,
  buildFuelPriceRows,
 ...
 *   isOwner         — verified ownership passed explicitly by the parent screen.
 *                     Resolved upstream via useVportDashboardContext on the dashboard
 *                     route, or useVportOwnership on the public /actor/:actorId/gas route.
...
export function GasPricesPanel({
   ...
   *     isOwner is the parent screen's verified ownership flag — making the gate explicit.

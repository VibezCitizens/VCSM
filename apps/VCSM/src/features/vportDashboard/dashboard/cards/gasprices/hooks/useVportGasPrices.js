...
import { getVportGasPricesController } from "@/features/vportDashboard/dashboard/cards/gasprices/controller/getVportGasPrices.controller";
...
export function useVportGasPrices({ actorId, fuelKey = null }) {
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      ...
      setPendingBatches(res.pendingBatches ?? []);
    } catch (e) {
      setError(e);
    } finally {
      setLoading(false);

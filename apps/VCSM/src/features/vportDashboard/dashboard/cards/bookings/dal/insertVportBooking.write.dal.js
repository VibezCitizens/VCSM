...
// VPD-V-019: customer_actor_id and created_by_actor_id MUST be session-derived values
// from the caller. Callers are responsible for setting these to the authenticated actor;
// never accept client-supplied actor IDs without session validation in the controller.
// VEN-DASHBOARD-003: DAL trust boundary — no direct callers outside createVportPublicBookingController.

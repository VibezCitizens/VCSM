 ...
 *
 * Run: npx vitest run src/features/vportDashboard/controller/__tests__/vportPublicBooking.controller.test.js
 */
...
vi.mock(
  "@/features/vportDashboard/dal/read/vportResource.read.dal",
  () => ({
...
vi.mock(
  "@/features/vportDashboard/dal/read/actorVport.read.dal",
  () => ({
...
vi.mock(
  "@/features/vportDashboard/dal/read/vportAvailabilityRules.read.dal",
  () => ({
...
vi.mock(
  "@/features/vportDashboard/dal/read/vportBookingsInRange.read.dal",
  () => ({
...
vi.mock(
  "@/features/vportDashboard/dal/read/vportServices.read.dal",
  () => ({
...
vi.mock(
  "@/features/vportDashboard/dashboard/cards/bookings/dal/insertVportBooking.write.dal",
  () => ({

...
import {
  searchDirectory as searchDirectoryController,
  startDirectConversation,
  getOrCreateDirectConversation,
  openConversation,
} from "@chat";

function resolvePickedActor(picked) {
  if (!picked) throw new Error("resolvePickedActor: missing picked");
  const actorId = picked.actorId || picked.id;
  if (typeof actorId !== "string") throw new Error("resolvePickedActor: invalid actorId");
  return actorId;
}

...
import { useAssignmentSubmission } from "@/learning/hooks/shared/useAssignmentSubmission";

import RubricList from "@/learning/components/common/assignments/RubricList";
import SubmissionFilesList from "@/learning/components/common/assignments/SubmissionFilesList";
import AssignmentSubmissionPanel from "@/learning/components/common/assignments/AssignmentSubmissionPanel";
import GradeSummaryCard from "@/learning/components/common/grades/GradeSummaryCard";
...
export default function LearningAssignmentScreen({
  ...
  if (isLoading) {
    return <LearningLoadingState label="Loading assignment..." />;
  }
  ...
  return (
    ...
    >
      ...
      {isSaving ? <LearningLoadingState label="Saving..." /> : null}

...
import { useCourseContent } from "@/learning/hooks/shared/useCourseContent";
import { useCourseAssignments } from "@/learning/hooks/shared/useCourseAssignments";
import LearningCourseViewScreen from "@/learning/screens/LearningCourseViewScreen.view";
...
export default function LearningCourseScreen({
  ...
  if (isLoading || assignmentsState.isLoading) {
    return <LearningLoadingState label="Loading course..." />;
  }

...
const FEATURE_CARDS = [
  {
    ...
    description: 'Organization management, roster controls, and operations from one workspace.',
  },
  {
    icon: Users,
    title: 'Teachers',
    description: 'Course delivery, assignment review, and submission workflows in the same route system.',
  },
  {
    icon: Building2,
    title: 'Parents',
    description: 'Observed progress, linked visibility, and assignment tracking without leaving the LMS.',
  },
  {
    icon: GraduationCap,
    title: 'Students',
    description: 'Course access, lesson progress, assignments, and next-step learning in one path.',
  },
]
...
function LoginHeroPanel({ isCompactLayout, isStackedLayout, featureColumnCount }) {
  return (
    ...
    >
      ...
      >
        One front door for the learning workspace.
      </h1>
      ...
      >
        Sign in to enter the LMS. Administration, teacher workflow, parent
        visibility, and student learning all live in the same workspace,
        with access assigned through your organization instead of public sign-up.
      </p>

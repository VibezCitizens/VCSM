...
export default function StudentLayout() {
  ...
  const NAV_LINKS = [
    { to: `/learning/${realmSlug}/student`, label: "Dashboard", end: true },
  ];

  if (learning.isLoading) {
    return <LearningLoadingState label="Loading student workspace..." variant="home" />;
  }
    ...
    <div className="role-layout">
      <aside className="role-sidebar">
        <div className="role-sidebar-header">
          ...
          <div className="role-sidebar-title">Students</div>

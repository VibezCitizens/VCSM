...
import { useStudentDashboard } from "@/learning/student/hooks/useStudentDashboard";
import { ContinueLearningCard } from "@/learning/student/components/ContinueLearningCard";
import { StudentCourseCard } from "@/learning/student/components/StudentCourseCard";
  ...
  return (
    <div style={{ padding: 24 }}>
      <LearningErrorState
        ...
        subtitle={error?.message ?? error?.code ?? "Failed to load student dashboard"}
        error={error}
        onRetry={onRetry}
      />
    </div>

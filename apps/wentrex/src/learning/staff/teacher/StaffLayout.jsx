...
export default function StaffLayout() {
  ...
  const NAV_LINKS = [
    { to: `/learning/${realmSlug}/teacher`, label: "Dashboard", end: true },
  ];

  if (learning.isLoading) {
    return <LearningLoadingState label="Loading staff workspace..." variant="home" />;
  }
    ...
    <div className="role-layout">
      <aside className="role-sidebar">
        <div className="role-sidebar-header">
          ...
          <div className="role-sidebar-title">Staff</div>

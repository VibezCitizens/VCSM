...
import { useLessonView } from "@/learning/administration/hooks/shared/useLessonView";
import { useLessonProgress } from "@/learning/administration/hooks/shared/useLessonProgress";

import LessonContent from "@/learning/administration/components/common/lessons/LessonContent";
...
export default function LearningLessonScreen({
  ...
  if (isLoading) {
    return <LearningLoadingState label="Loading lesson..." variant="detail" />;
  }

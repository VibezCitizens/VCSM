...
import { listOrganizationMembersController } from "@/learning/administration/controller/admin/listOrganizationMembers.controller";
import { assignOrganizationMemberController } from "@/learning/administration/controller/admin/assignOrganizationMember.controller";
import { createOrganizationMemberController } from "@/learning/administration/controller/admin/createOrganizationMember.controller";
    ...
    async ({
      ...
      if (!organizationId || !displayName || !email) {
        const nextError = {
          code: "VALIDATION_ERROR",
          message:
            "createMember requires organizationId, displayName, and email",
        };
      ...
      try {
        const result = await createOrganizationMemberController({
          organizationId,
          displayName,
          email,
          username,
        ...
        const nextError = {
          code: "DB_ERROR",
          message: err?.message ?? "Failed to create organization member",
        };

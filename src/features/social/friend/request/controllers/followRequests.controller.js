...
export async function ctrlSendFollowRequest({
  ...
  // ✅ Notifications are generated by DB trigger on vc.social_follow_requests
  return 'pending'
}
...
export async function ctrlAcceptFollowRequest({
  ...
  // ✅ If you have a DB trigger for accept notifications, keep it there.
  // If you do NOT have one, then re-add the client notification (but not both).
  return true
}

...
export default function MessageMedia({
  ...
  // ✅ IMPORTANT:
  // border/ring on DIV wrapper so it always renders (CSS resets often kill button borders)
  const shellClass = [
    'mb-1',
    'w-full max-w-full',
    'rounded-2xl overflow-hidden',
    'bg-black/20',
    'border border-purple-500/50', // thin purple lining
    'ring-1 ring-purple-400/10',   // extra thin glow (still subtle)
    className,
  ].join(' ')

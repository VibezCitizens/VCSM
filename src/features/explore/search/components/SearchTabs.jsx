          ...
          case 'user':
            return (
              <div
                ...
                className="flex items-center gap-3 p-3 bg-neutral-800 rounded-none border border-neutral-700 cursor-pointer hover:bg-neutral-700 transition"
              >
                <img
          ...
          case 'post':
            return (
              <div
                ...
                className="p-3 bg-neutral-900 rounded-none border border-neutral-700 cursor-pointer hover:bg-neutral-800 transition"
              >

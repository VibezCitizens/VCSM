...
export default function DesignStudioInlineColorPicker({ value, onChange, disabled = false }) {
  ...
  return (
    <div ref={hostRef} style={{ position: "relative" }}>
      <button
        type="button"
        style={{ ...colorTrigger, opacity: disabled ? 0.55 : 1, cursor: disabled ? "not-allowed" : "pointer" }}
        onClick={() => {
          if (disabled) return;
          setOpen((v) => !v);
        }}

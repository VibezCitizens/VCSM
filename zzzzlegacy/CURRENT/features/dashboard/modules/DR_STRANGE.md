---
# DR. STRANGE ENTRY — MODULES

**Category Key:** dashboard
**Type:** FEATURE
**CURRENT Path:** features/dashboard/modules
...
Modules dashboard sub-area. Part of the VPORT dashboard system.
...
Sub-directories: availability barber barbershop booking calendar content-pages dashboard dashboard-cards delete-lifecycle exchange flyer-builder gas invite join leads locksmith menu portfolio qrcode restaurant reviews schedule services settings settings-vports subscribers tab-classification team vport-core

...
- vport schema: resources, bookings, availability_rules, availability_exceptions, organizations, locations, qr_links, resource_service_overrides, profiles (read), services (read)

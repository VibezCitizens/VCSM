...
import nativeBottomNavRaw from '../data/native/native-bottom-navigation.graph.json'
...
export const NATIVE_GRAPHS = [
  {
    id: 'native-bottom-navigation',
    label: 'Full Native App',
    group: 'App',
    ...buildGraph(nativeBottomNavRaw),
  },
]

export function getNativeGraphById(id) {
  return NATIVE_GRAPHS.find((g) => g.id === id) || null
}

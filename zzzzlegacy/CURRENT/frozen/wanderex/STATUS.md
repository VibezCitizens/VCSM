# wanderex — Freeze Status Record

Feature: wanderex
Source Path: apps/VCSM/src/features/wanderex/
Status: FROZEN
Owner: LOGAN
...
Product work paused. The wanderex feature is not part of active platform development.
No sprint work, migrations, or governance actions are planned for this feature at this time.
...
- Dependency lookup (does another feature import from wanderex?)
...
- Product work on wanderex resumes

...
|---|---|---|
| `/Wolverine` | Main planning, routing, and execution orchestrator | `.Codex/commands/Wolverine.md` |
| `/Logan` | Documentation review, drift detection, sync | `.Codex/commands/Logan.md` |
| `/Deadpool` | Root cause debug command | `.Codex/commands/Deadpool.md` |
| `/CAPTAIN` | Next-session order capture (ideas only) | `.Codex/commands/CAPTAIN.md` |
| `/DB` | Database reviewer and analyst | `.Codex/commands/DB.md` |
| `/ARCHITECT` | Repository architecture mapping & DB read audit | `.Codex/commands/ARCHITECT.md` |
| `/Loki` | Runtime observability and request trace | `.Codex/commands/Loki.md` |
| `/Kraven` | Performance hunter and bottleneck analysis | `.Codex/commands/Kraven.md` |
| `/Venom` | Security sheriff and trust boundary review | `.Codex/commands/Venom.md` |
| `/Carnage` | Database migration architect | `.Codex/commands/Carnage.md` |
| `/Ironman` | Feature ownership and system responsibility | `.Codex/commands/Ironman.md` |
| `/Thor` | Release commander | `.Codex/commands/Thor.md` |
| `/NickFury` | Parallel build orchestrator — isolated side-missions | `.Codex/commands/NickFury.md` |
| `/Falcon` | iOS parity governance — PWA → Native transfer | `.Codex/commands/Falcon.md` |
| `/Vision` | Analytics intelligence — telemetry, funnels, attribution | `.Codex/commands/Vision.md` |
| `/review-contract` | Architecture contract compliance check | `.Codex/commands/review-contract.md` |
| `/session-summary` | End-of-session audit log | `.Codex/commands/session-summary.md` |

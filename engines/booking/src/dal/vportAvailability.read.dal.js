...
export async function dalListVportAvailabilityRulesByResourceId({ resourceId, includeInactive = false }) {
...
export async function dalListVportAvailabilityExceptionsInRange({ resourceId, rangeStart, rangeEnd, exceptionTypes = null }) {
  if (!resourceId) throw new Error('BookingEngine: resourceId is required')

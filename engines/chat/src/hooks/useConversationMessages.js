...
import { getConversationMessagesController }
  from '../controller/getConversationMessages.controller.js'
import { sendMessageController }
  from '../controller/sendMessage.controller.js'
import { editMessageController }
  from '../controller/editMessage.controller.js'

// delete / unsend actions
import { deleteMessageForMeController }
  from '../controller/deleteMessageForMe.controller.js'
import { unsendMessageController }
  from '../controller/unsendMessage.controller.js'

// realtime
import { subscribeToConversation }
  from '../dal/subscribeToConversation.js'
...
export default function useConversationMessages({
  ...
  async ({ body = '', type = 'text', mediaUrl = null, attachments = [] }) => {
    ...
    const hasMedia = !!mediaUrl || attachments.length > 0
